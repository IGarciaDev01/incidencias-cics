...
import {
    ...
    aprobar,
    rechazar,
} from '@/routes/panel/sindicato/incidencias';
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        {tab === 'aprobar' && (
                            ...
                            >
                                ...
                                <p className="text-xs text-gray-500">Esta es la aprobación final. La incidencia quedará aprobada definitivamente.</p>
                                <Button type="submit" size="sm" disabled={aprobarForm.processing}>
                                    {aprobarForm.processing && <Spinner />} Confirmar aprobación definitiva
                                </Button>
                            </form>
                        )}
