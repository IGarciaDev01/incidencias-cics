...
import {
    index as subdirIndex,
    create,
    destroy,
    edit,
} from '@/routes/panel/subdireccion/admin/areas';
...
function useAreaRoutes() {
    ...
    return {
        ...
        incidenciasUrl: (isCh
            ? chIncidenciasIndex.url
            : incidenciasIndex.url) as (opts?: Record<string, any>) => string,
                ...
                <form
                    onSubmit={(e) => {
                        ...
                        router.get(
                            ...
                            {
                                buscar:
                                    (fd.get('buscar') as string) || undefined,
                            },
                            { replace: true },
                        );
                    }}
                                    ...
                                    areas.data.map((area) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3">
                                                <span
                                                    className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium ${area.activa ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-500'}`}
                                                >
                                                    {area.activa
                                                        ? 'Activa'
                                                        : 'Inactiva'}
