...
type Props = {
    ...
    filtros: { estado?: string; tipo?: string; buscar?: string; fecha_inicio?: string; fecha_fin?: string };
    estados: EnumItem[];
    tipos: EnumItem[];
};
    ...
    return (
        <>
            ...
            <div className="p-4 md:p-6 space-y-5">
                <div>
                    <h2 className="text-xl font-semibold text-gray-900">Registro de Incidencias</h2>
